...
const bridge =
  ',ee=0;window.__POLYTRACK_062__={version:"0.6.2",replay:null,get audio(){return window.__POLYVIEWER_AUDIO__??null},get renderer(){return d},get scene(){return d.scene},get camera(){return d.camera},get canvas(){return d.canvas},get state(){return $}};d.setAnimationLoop((function(e){const t=Math.max(e-ee,0)/1e3;ee=e,d.polyviewerCaptureState||$.update(t),M.update(t)}))';
...
const carVisibilityReplacement = 'setVisible(e){this.polyviewerVisible=!!e,(0,l.gn)(this,me,"f").visible=e,e||(0,l.gn)(this,Ne,"f")?.clear();if(!e){for(const e of(0,l.gn)(this,Pe,"f"))e.clear();null!=(0,l.gn)(this,ve,"f")&&((0,l.gn)(this,ve,"f").visible=!1)}}polyviewerSetRenderEffects(e){const t=e?.particles!==!1,n=e?.skidmarks!==!1;(0,l.gn)(this,Ne,"f")?.setVisible(t),t||(0,l.gn)(this,Ne,"f")?.clear();for(const e of(0,l.gn)(this,Pe,"f"))e.setVisible(n),n||e.clear()}polyviewerSetNameTagEnabled(e){this.polyviewerNameTagEnabled=!!e;(0,l.gn)(this,D,"m",Fe).call(this);this.polyviewerRefreshNameTag()}polyviewerRefreshNameTag(){const e=(0,l.gn)(this,ve,"f");if(null!=e){const t=this.getPosition(),n=new c.Pq0(0,1,0).applyQuaternion(this.getQuaternion());e.position.copy(t).addScaledVector(n,1.75);e.visible=this.polyviewerVisible!==!1&&this.polyviewerNameTagEnabled===!0,e.visible&&(e.lookAt((0,l.gn)(this,ge,"f").camera.position),e.updateMatrixWorld(!0))}}polyviewerGetExportCar(){return{matrix:(0,l.gn)(this,be,"f").matrixWorld.toArray(),braking:(0,l.gn)(this,te,"f").brakeLightEnabled===!0,visible:(0,l.gn)(this,me,"f").visible}}getCarState(){';
const nameTagVisibilityAnchor = '.visible=(0,l.gn)(this,te,"f").hasStarted&&i>=r*r&&i<=a*a,';
const nameTagVisibilityReplacement = '.visible=this.polyviewerVisible!==!1&&this.polyviewerNameTagEnabled===!0,';
...
const replayManagementBridge = `;{
  ...
  const pvCreateReplayStore=pvSampleFrames=>{const pvStore=window.__POLYVIEWER_CREATE_PACKED_REPLAY_STORE__?.(pvSampleFrames?{sampleFrames:pvSampleFrames}:void 0);if(!pvStore)throw new Error("PolyViewer replay storage is not ready. Reload once and try again.");return{get polyviewerPackedBytes(){return pvStore.packedBytes},push:pvState=>pvStore.push(pvState),pushPacked:pvBytes=>pvStore.pushPacked(pvBytes),getFrame:pvFrame=>pvStore.getFrame(pvFrame),forEachFrameNumber:(pvFirst,pvLast,pvVisit)=>pvStore.forEachFrameNumber(pvFirst,pvLast,pvVisit),getLastFrame:()=>new bt.A(pvStore.lastFrame)}};
...
const replayOverlayBridge =
  ';{for(const pvEntry of(0,R.gn)(pvOwner,jp,"f"))pvEntry.car.polyviewerNameTagEnabled=pvEntry.polyviewerNameTagVisible===!0,pvEntry.car.setNameTag(null,pvEntry.polyviewerName);pvReplay.setReplayNameTagVisible=(pvId,pvVisible)=>{const pvEntry=pvReplay.getCatalogEntry(pvId);if(!pvEntry)throw new Error("Replay not found");pvEntry.polyviewerNameTagVisible=!!pvVisible;const pvCar=pvReplay.getCar(pvId);pvCar&&pvCar.polyviewerSetNameTagEnabled(!!pvVisible);pvReplay.refreshPerformance()};pvReplay.refreshOverlays=()=>{for(const pvEntry of(0,R.gn)(pvOwner,jp,"f"))if(pvEntry.car.polyviewerNameTagEnabled===!0)pvEntry.car.polyviewerRefreshNameTag()}}';

const replayEvaluationBridge =
  ';pvReplay.evaluatedFrame=pvReplay.timeFrames,pvReplay.evaluateFrame=(pvRequestedFrame,pvAdvanceVisuals)=>{if(!Number.isSafeInteger(pvRequestedFrame)||pvRequestedFrame<0)throw new RangeError("Replay frame must be a non-negative safe integer.");const pvTarget=Math.max(0,Math.min(pvReplay.durationFrames,pvReplay.loadedFrames,pvRequestedFrame)),pvPrevious=pvReplay.evaluatedFrame,pvEntries=(0,R.gn)(pvOwner,jp,"f"),pvActive=pvEntries.filter(pvEntry=>pvEntry.polyviewerPreviewVisible!==!1||pvEntry.polyviewerId===pvReplay.priorityReplayId),pvApplyState=(pvEntry,pvFrame)=>{const pvAvailableFrame=Math.min(pvFrame,pvEntry.replay.getLastFrame().numberOfFrames),pvState=pvEntry.replay.getFrame(pvAvailableFrame);if(null!=pvState&&pvEntry.car.getTime().numberOfFrames!=pvState.frames)pvEntry.car.setCarState(pvState,pvState.frames!=pvEntry.car.getTime().numberOfFrames&&pvState.frames!=pvEntry.car.getTime().numberOfFrames+1)};let pvDelta=0;if(pvAdvanceVisuals&&pvTarget>pvPrevious){for(const pvEntry of pvActive){if(pvEntry.replay.forEachFrameNumber)pvEntry.replay.forEachFrameNumber(pvPrevious+1,pvTarget,pvFrame=>pvApplyState(pvEntry,pvFrame));else for(let pvFrame=pvPrevious+1;pvFrame<=pvTarget;pvFrame++)pvApplyState(pvEntry,pvFrame);}pvDelta=(pvTarget-pvPrevious)/1e3}else for(const pvEntry of pvActive)pvApplyState(pvEntry,pvTarget);for(const pvEntry of pvActive){pvEntry.car.update(pvDelta);(pvEntry.polyviewerId==="main"||pvEntry.polyviewerId===pvReplay.priorityReplayId)&&pvEntry.car.updateCameras(pvDelta)}pvReplay.evaluatedFrame=pvTarget,(0,R.GG)(pvOwner,qp,pvTarget/1e3,"f"),(0,R.GG)(pvOwner,Kp,!0,"f"),(0,R.gn)(pvOwner,Yp,"f").isPaused=!0,pvReplay.nativeCameraPose=pvReplay.getNativeCameraPose("main")};';
...
const resourcePatches = [
  [',null!=(0,l.gn)(this,Ae,"f")){const e=document.createElement("canvas")', ',this.polyviewerNameTagEnabled!==!1&&null!=(0,l.gn)(this,Ae,"f")){const e=document.createElement("canvas")', 1],
  ['(0,l.gn)(this,ge,"f").scene.add((0,l.gn)(this,ve,"f"))}}},Oe=function', '(0,l.gn)(this,ge,"f").scene.add((0,l.gn)(this,ve,"f")),this.polyviewerRefreshNameTag()}}},Oe=function', 1],
