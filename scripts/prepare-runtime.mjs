...
const replayApplyReplacement = replayApplyAnchor;
...
if (replayClassOccurrences !== 1 || replayDisposeOccurrences !== 1 || replayUpdateOccurrences !== 1 || nativeCameraUpdateOccurrences !== 1 || replayApplyOccurrences !== 1 || carVisibilityOccurrences !== 1 || nameTagVisibilityOccurrences !== 1 || skidSpawnOccurrences !== 1 || particleSpawnOccurrences !== 1) {
  throw new Error(
    `Refusing to patch PolyTrack replay state: verified anchor count mismatch ${replayClassOccurrences}/${replayDisposeOccurrences}/${replayUpdateOccurrences}/${nativeCameraUpdateOccurrences}/${replayApplyOccurrences}/${carVisibilityOccurrences}/${nameTagVisibilityOccurrences}/${skidSpawnOccurrences}/${particleSpawnOccurrences}.`,
  );
}
